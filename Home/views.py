...
# Optional imports for full AI mode
try:
    import cv2
    import numpy as np
    CV2_AVAILABLE = True
...
def detect(request):
    ...
    if not CV2_AVAILABLE:
        ...
        logger.info("Running in demo mode - OpenCV not available")
        
        # Simple demo logic - randomly detect "fire" occasionally
        demo_fire = 1 if random.random() < 0.15 else 0  # 15% chance
        demo_conf = random.uniform(55, 95) if demo_fire else random.uniform(5, 45)
        ...
        return JsonResponse({
            ...
            "sms_sent": False,
            "demo_mode": True,
            "message": "Demo mode - AI libraries not installed (save disk space)"
        })
    ...
    if model is None:
        # Demo mode - simulate fire detection for testing
        logger.info("Running in demo mode - YOLO model not available")
        ...
        return JsonResponse({
            ...
            "sms_sent": False,
            "demo_mode": True,
            "message": "Demo mode - YOLO not available"
        })
